...
async function setExecutor() {
    ...
    try {
        ...
        const currentExecutor = await vault1.executor();
        ...
        const tx = await vault1.setExecutor(wallet.address);
        console.log(`Transaction sent: ${tx.hash}`);
        await tx.wait();
        console.log("✅ Executor Updated Successfully!");
        const newExecutor = await vault1.executor();
...
setExecutor();
//# sourceMappingURL=set_executor.js.map