...
contract P2PTokenEscrowsTest is Test {
    ...
    // Events to check (Must match your contract definition)
    ...
    function test_FullPurchaseFlow() public {
        ...
        // 4. Owner Releases (Current Logic Restriction)
        // NOTE: In a real P2P, the Seller should do this, but your code requires Owner
        vm.expectEmit(true, true, true, true);
    ...
    function test_RevertRelease_IfNotOwner() public {
        ...
        // Seller tries to release (This fails in your current code, but arguably SHOULD work in P2P)
        vm.prank(seller);
        // vm.prank(address(this));
        // vm.expectRevert("Ownable: caller is not the owner");
        // We expect the OwnableUnauthorizedAccount error, with the 'seller' address as the argument
        vm.expectRevert(
