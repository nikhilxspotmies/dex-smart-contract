...
import { getMarkets, submitOrder, getPositions, getMarkPrice, getFundingRate, deposit, withdraw, closePosition, adminSetPrice, adminUpdateFunding, } from '../controllers/perpetual.controller.js';
const router = Router();
// Public endpoints
