...
export class PositionService {
     ...
     */
    async getPosition(user, marketSymbol) {
        try {
            // Get market config
            ...
            const summary = await contract.read.getAccountSummary([user]);
            ...
            const accountData = await contract.read.accounts([user]);
     ...
     */
    async getPositionSummary(user, marketSymbol) {
     ...
     */
    updatePositionFromEvent(user, market, eventData) {
